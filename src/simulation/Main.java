...
public class Main {
	...
	public static void main(String[] args) {
		Simulation verletSimulation = new VerletSimulation(MASS, K, GAMMA, FINAL_TIME, DELTA_TIME, INITIAL_POSITION, INITIAL_VELOCITY);
		Simulation beemanSimulation = new BeemanSimulation(MASS, K, GAMMA, FINAL_TIME, DELTA_TIME, INITIAL_POSITION, INITIAL_VELOCITY);
		Simulation gearPredictorCorrectorSimulation = new GearPredictorCorrectorSimulation(MASS, K, GAMMA, FINAL_TIME, DELTA_TIME, INITIAL_POSITION, INITIAL_VELOCITY);
